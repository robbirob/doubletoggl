package com.example.doubtogg.controller;

import com.example.doubtogg.features.BookstoreFeatures;
...
public class BookController {
  ...
  public ResponseEntity<ArrayNode> getBookWishlist() {
    ...
    if (featureManager.isActive(BookstoreFeatures.BOOK_WISHLIST)) {
